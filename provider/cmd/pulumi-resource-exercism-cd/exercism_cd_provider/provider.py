...
import exercism_cd_provider
from exercism_cd_provider.staticpage import StaticPage, StaticPageArgs


class Provider(provider.Provider):

    def __init__(self) -> None:
        super().__init__(exercism_cd_provider.__version__)
    ...
    def construct(self,
        ...
        if resource_type == 'exercismcd:index:StaticPage':
