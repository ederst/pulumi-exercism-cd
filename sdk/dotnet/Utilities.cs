...
namespace Pulumi.Exercism-cd
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Exercism-cd.version.txt");
    ...
    internal sealed class Exercism-cdResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public Exercism-cdResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
